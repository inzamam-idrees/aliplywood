                        ...
                        <form  method="POST" action="{{route('invoice.update',$invoice->id)}}">
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="employee" class="form-control" value="{{ old('employee', $invoice->employee) }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="control-label">Bill No.</label>
                                    <input type="text" name="bill_no" class="form-control" value="{{ old('bill_no', $invoice->bill_no) }}">
                                </div>
                            </div>
                            <div class="row col-md-12">
                                <div class="form-group col-md-4">
                                    <label class="control-label">Date</label>
                                    <input name="order_date" class="form-control datepicker" value="{{ \Carbon\Carbon::parse($invoice->order_date)->format('Y-m-d') }}" type="date" placeholder="Date">
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($sales as $sale)
                                 <tr>
                                    ...
                                    <!-- <td><input value="{{-- $sale->dis --}}" type="number" min="0" name="dis[]" class="form-control dis" ></td> -->
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b class="total_products">{{ $invoice->total_products }}</b>
