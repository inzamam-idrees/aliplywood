...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> Edit Customer Form</h1>
            </div>
                    ...
                    <div class="tile-body">
                        <form class="row" method="POST" action="{{route('customer.update', $customer->id)}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input value="{{ old('name', $customer->name) }}" name="name" class="form-control @error('name') is-invalid @enderror" type="text" placeholder="Enter Customer Name">
                                @error('name')
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input value="{{ old('mobile', $customer->mobile) }}" name="mobile" class="form-control @error('mobile') is-invalid @enderror" type="text" placeholder="Enter Contact Number">
                                @error('mobile')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
